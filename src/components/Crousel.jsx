...
const Carousel = () => {
  ...
  return (
    <div className="relative w-full h-[580px] overflow-hidden bg-gradient-to-r from-[#0f2027] via-[#203a43] to-[#2c5364]">
      {/* Arrows */}
      <button
        onClick={prev}
  ...
  <div className="flex flex-wrap gap-3 text-sm">
    ...
    <button className=" mt-4 bg-gradient-to-r from-[#0f2027] to-[#764ba2] text-white px-6 py-3 rounded-xl shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl capitalize">Show More</button>
  </div>
</div>
